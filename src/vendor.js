...
This is used by webpack in production build only*. A separate bundle for vendor code 
...
one of them change. So basically, this avoids customers having to download a huge JS 
file anytime a line of code changes. They only have to download vendor.js when a vendor 
library changes which should be less frequent. Any files that are not referenced here 
